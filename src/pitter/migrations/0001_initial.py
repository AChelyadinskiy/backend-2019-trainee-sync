        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'followed',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='followed', to='pitter.User'
                    ),
                ),
                (
                    'follower',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='follower', to='pitter.User'
                    ),
                ),
            ],
            options={'abstract': False,},
